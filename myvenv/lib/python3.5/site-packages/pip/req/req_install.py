...
from pip.compat import WINDOWS, get_stdlib, native_str
from pip.download import is_archive_file, is_url, path_to_url, url_to_path
from pip.exceptions import (InstallationError, UninstallationError,
                            UnsupportedWheel)
from pip.locations import (PIP_DELETE_MARKER_FILENAME, bin_py, bin_user,
                           running_under_virtualenv)
from pip.req.req_uninstall import UninstallPathSet
from pip.utils import (FakeFile, _make_build_dir, ask_path_exists, backup_dir,
                       call_subprocess, display_path, dist_in_site_packages,
                       dist_in_usersite, dist_is_local, egg_link_path,
                       ensure_dir, get_installed_version, is_installable_dir,
                       normalize_path, read_text_file, rmtree)
